...
if enable_ai_chat and GOOGLE_API_KEY and st.session_state.extracted_data:
    ...
    st.session_state.analysis_context = current_context, '').replace(',', '').strip()
                balance = float(balance_str) if balance_str and balance_str != 'nan' else 0.0
...
if enable_personal_funding and uploaded_file:
    ...
    personal_analysis, personal_message, personal_projects = analyze_all_personal_funding(uploaded_file)
