...
if 'benedicks_data' not in st.session_state: # Added for benedicks data
    st.session_state.benedicks_data = None
if 'benedicks_projects' not in st.session_state: # Added for benedicks projects
...
                bl_names = [bl[0][:20] + "..." if len(bl[0]) > 20 else bl[0] for bl in top_bl_codes]
